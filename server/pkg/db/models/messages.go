...
var MessageWhere = struct {
	...
	AuthorID: whereHelperint{field: "\"messages\".\"author_id\""},
	Text:     whereHelperstring{field: "\"messages\".\"text\""},
	Time:     whereHelperstring{field: "\"messages\".\"time\""},
}
...
var (
	messageAllColumns            = []string{"id", "author_id", "text", "time"}
	messageColumnsWithoutDefault = []string{"author_id", "text", "time"}
...
func (messageL) LoadAuthor(e boil.Executor, singular bool, maybeMessage interface{}, mods queries.Applicator) error {
	var slice []*Message
	var object *Message
...
func (o *Message) SetAuthor(exec boil.Executor, insert bool, related *User) error {
	var err error
	if insert {
